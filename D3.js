...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  if (isFemale) {
    femaleCharacters.push(characterName);
  }
}
...
// let message = null
// if (crewMass < 500) {
//   message = "Ship is under loaded"
// } else if (crewMass >= 500 && crewMass < 700) {
//   message = "Ship is half loaded"
// } else if (crewMass >= 700 && crewMass < 900) {
//   message = "Warning: Load is over 700"
// } else if (crewMass >= 900 && crewMass < 1000) {
//   message = "Critical Load: Over 900"
// } else {
//   message = "DANGER! OVERLOAD ALERT: escape from ship now!"
// }
...
/* ESERCIZIO 8
  ...
  di alcuni personaggi dal valore "n/a" a "robot" (Tip: puoi effettuare la riassegnazione del valore corrispondente o creare un nuovo array)
*/
...
//   const nomeCarattereQualsiasi = charactersNames[i];
//   for (let j = 0; j < femaleCharacters.length; j++) {
//     const nomeCarattereFemmina = femaleCharacters[j];
//     if (nomeCarattereQualsiasi === nomeCarattereFemmina) {
...
const caratterePescato = starWarsCharacters[indiceCasuale]
const proprietaScelta = caratterePescato.mass
let descrizioneProprieta = "La massa è un elemento fondamentale nella teoria del caos"

console.log(descrizioneProprieta)